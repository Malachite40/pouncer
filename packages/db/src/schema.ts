...
export const watches = pgTable('watches', {
    ...
    priceDropThreshold: numeric('price_drop_threshold'),
    priceDropPercentThreshold: numeric('price_drop_percent_threshold'),
    priceDropTargetPrice: numeric('price_drop_target_price'),
    priceIncreaseThreshold: numeric('price_increase_threshold'),
    priceIncreasePercentThreshold: numeric('price_increase_percent_threshold'),
